class ApplicationController < ActionController::Base
  ...
  def form_params
    ...
    instance_methods = noun.capitalize.constantize.public_instance_methods(include_super=false)
    instance_methods.map { |method| method.to_sym }

    params.require(noun.to_sym).permit(columns, instance_methods )
  end
